...
export default function Navigation() {
  ...
  return (
    <nav className="fixed top-0 w-full nav-blur z-50">
      <div className="px-6 sm:px-12 lg:px-24 py-0">
        <div className="container-max">
          <div className="flex items-center justify-between h-16">
            <a href="#" className="text-xl font-semibold text-gradient">
              <span className="text-black dark:text-white font-bold">Y</span>
              <span className="text-gray-500 dark:text-gray-400 font-medium">VV</span>
            </a>
